...
class ProfileReviewsForProviderViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        // Dequeue the correct cell type
        let cell = tableView.dequeueReusableCell(withIdentifier: "ProviderReviewCell", for: indexPath) as! ProvidersRevTableViewCell
